...
using UnityEngine;
public class Move_guard1 : MonoBehaviour {
...
/* 원본 출처 : http://theflyingkeyboard.net/unity/unity-c-moving-gameobject-from-point-a-to-point-b/
 * + 수정 : 박현우 (주석, 방향틀기 등 우리 게임에 맞게 수정)
 */